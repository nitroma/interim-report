...
For product selection, $\lambda_{max}$=3.1218, CI=0.0409 and RI=0.58, hence the consistency ratio is worth 1. Weightings are deemed consistent if the ratio is less than 10\%.\\
