...
\toprule
                                          & \multicolumn{2}{c}{Economic potential   (29\%)}                                & \multicolumn{1}{|>{\hsize=\dimexpr2\hsize+2\tabcolsep}X}{Performance (14\%)} & \multicolumn{3}{|c|}{EHS (57\%)}     &                       &                          &                           \\ \cmidrule{2-7}
                                          & {\splitcell{Price\\(\si{\USD\per\kg})}} & {\splitcell{CAGR\\(\%)}} & Conversion  & \rotatebox[origin=r]{90}{Health} & \rotatebox[origin=r]{90}{Flammability} & \rotatebox[origin=r]{90}{Instability} & AHP & TOPSIS & Rank \\ \midrule
H-ZSM-5 & 0.734        & 0.5 & 41                             &       &            &            & 0.297                 & 0.752                & 2                         \\ 
H-Y & 0.696            & 0.48 & 36                           &       &             & 0           & 0.276                 & 0.705                   & 3 \\ 
H-Mordenite       & 0.726           & 0.55  & 43                            &       &             & 0           & 0.303                 & 0.761                  & \cellcolor{green}1 \\ 
