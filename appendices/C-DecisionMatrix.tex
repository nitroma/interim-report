...
\centering
    ...
    \label{tab:solvent}\footnotesize
\begin{tabularx}{\linewidth}{l|ll|lll|ll|llll|X|X|S[table-format=1.3]S[table-format=1.3]c}
%S[table-format=2.2]S[table-format=1.2]S[table-format=1.3]
\toprule
                                          & \multicolumn{2}{c|}{Supply chain   (34\%)}                               & \multicolumn{3}{c|}{Country economics (17\%)} & \multicolumn{2}{c|}{\splitcell{Trade\\ (4\%)}}     & \multicolumn{3}{c|}{Operating costs (28\%)}   & Competitive Landscape (7\%) & Political stability (7\%)  &     &                      \\ \cmidrule{2-11}
