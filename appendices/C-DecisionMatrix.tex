...
\toprule
                                       ...
                                       & \splitcell{Local\\ toluene\\production (\si{\t\per\year})} & {\splitcell{Industry\\size of \\products (\si{\USD b})}} & {\splitcell{Interest\\ rate (\si{\percent})}}  &{\splitcell{Corporate\\tax rate (\si{\percent})}}& \rotatebox[origin=r]{90}{Inflation (\si{\percent})} & \rotatebox[origin=r]{90}{Import duties (\si{\percent})} & \rotatebox[origin=r]{90}{Renewability} & \rotatebox[origin=r]{90}{Environment} & \rotatebox[origin=r]{90}{Waste} & \rotatebox[origin=r]{90}{LCA} & AHP & TOPSIS & Rank \\ \midrule
