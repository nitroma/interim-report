...
Column heights were calclated by using the rule that quoted in Douglas et al the height should be 20-30 times the diameter of the column, to prevent buckling under strong winds if too tall. 

\begin{equation}
    H_t = \left[\frac{4G}{(fU_f)\pi\left(1-\frac{A_d}{A_T}\right)\rho_g}\right]^\frac{1}{2}
