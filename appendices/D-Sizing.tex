...
\end{equation}
Equation \ref{eqn:decanter_vol_sizing} was used to determine the volume of the decanter, V, where $V_A$ and $V_B$ ($m^$  are the volumetric flowrate of the liquids. 
