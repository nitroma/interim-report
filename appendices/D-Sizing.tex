...
\begin{equation}
    \text{Total liquid hold up} = (V_A + V_B)t
    \label{decanter_holdup_sizing}
\end{equation}
where $V_A$ and $V_B$ are the volumetric flowrate of the liquids. The vessel should be 95 \% full, from this the volume of the decanter was determined. 
