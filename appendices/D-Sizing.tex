...
\begin{equation}
    ...
    \label{decanter_vol_sizing}
\end{equation}
\ref{decanter_vol_sizing} was used to determine the volume of the decanter, V, where $V_A$ and $V_B$ are the volumetric flowrate of the liquids. 
