...
According to information learnt from Froment/Bischoff, all 4 reactors chosen (packed-bed microreactor, trickle bed reactor, fixed bed reactor, xxx) can be assumed to have the same design equation as a plug flow reactor, due to the reason of 
