...
\noindent Column heights were calculated by using a general rule quoted in Douglas et al \cite{douglas_conceptual_1988} that the height should be 20-30 times the diameter of the column, to prevent buckling under strong winds if too tall so a ratio of 25 was taken. 
