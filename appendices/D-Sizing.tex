% !TeX root = ../main.tex
\section{Unit Sizing Sethodology}
\label{app:sizing}
...
\paragraph{Sizing of crystallisers}
...
where V is the volume of the crystal and $F_{crystal}$ is the solid production rate of the crystalliser employed in this design. 
