...
\begin{equation}
    ...
    \label{decanter_dia_sizing}
\end{equation}
where t is separation time, $\mu$ is viscosity of the continuous phase, $\rou_A$ and $\rou_B$ are the densities of the liquids to be separated. 
