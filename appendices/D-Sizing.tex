...
The distillation columns have been designed following the method outlined in []. The diameter of the tower is designed to avoid entrainment flooding.  \ref{crystalliser_sizing} below:

\begin{equation}
    D_t = \frac{4G}{(fU_f)(1-A~ton/yr} \times 2~((4/2~m)^2 \pi \times 12~m)
