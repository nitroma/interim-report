...
Assumptions, methods, and sources of reference for sizing the separator units are summarised in Table \ref{}.


\begin{table}[h]
    \caption{Assumptions and methods for sizing the separator units with references}
