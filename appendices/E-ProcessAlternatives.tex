...
Based on X paper, (include why reactors are PFR)
The design equation for all 4 reactors were assumed to be same as the design equation of a plug flow reactor (check), which can be defined in the equation below:
