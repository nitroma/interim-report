...
The design equation for all reactors were assumed to be same as the design equation of a plug flow reactor (check), which can be defined in the equation below:
