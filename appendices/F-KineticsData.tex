...
\begin{itemize}
    ...
    \begin{equation}
    - \frac{\dd C_{toluene}}{\dd t}=k \cdot C_{toluene} 
    \end{equation}
...
\begin{itemize}
    ...
    \begin{equation}
    - \frac{\dd C_{ONT}}{\dd t}=k \cdot P_{\ch{H2}}^{0.3} 
    \end{equation}
    \item The rate constant, in mol/(kPa$^{0.3}$g$_{cat}$s), is valid for a reaction temperature range of \SIrange{333}{363}{\K} \cite{rajadhyaksha_solvent_1986}:
    \begin{equation}
