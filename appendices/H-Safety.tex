...
\label{tab:chemID}\\
\toprule
\multirow{2}{*}{\splitcell{Chemical\\ Substance \cite{fischersci_sds_nodate}}}                                                                                          & \multicolumn{3}{c}{\textbf{NFPA 704 Ratings}}                                                                                         & \multirow{2}{*}{\splitcell{Flash Point\\ (°C)}}                                                                                      & \multirow{2}{*}{\splitcell{Auto-ignition\\ Temperature (°C)}}                                                                                                        & \multirow{2}{*}{\splitcell{Vapour Pressure\\ (kPa) at 25°C \cite{scifinder_supplier_nodate}}}                                                                                                      & \multirow{2}{*}{\splitcell{Globally Harmonized System (GHS)\\ Hazard Codes \& Statements \cite{pubchem_pubchem_nodate}}}                                                                                                                                                                                                                                                                                                                          \\ \cmidrule{2-4}
& \cellcolor[HTML]{5695F1}\textbf{Health} & \cellcolor[HTML]{F85233}\textbf{Flammability} & \cellcolor[HTML]{F8FF00}\textbf{Reactivity} &  &  &  & \\ \midrule
