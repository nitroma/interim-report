...
\begin{landscape}
\begin{table}[]
\caption{Fire and Explosion Indices}
...
\begin{tabular}{@{}cll@{}}
\toprule
\textbf{Category}                                                   & \multicolumn{1}{c}{\textbf{Applicable Substances}}                                                                                                                           & \multicolumn{1}{c}{\textbf{\begin{tabular}[c]{@{}c@{}}Best Available Techniques \cite{european_commission_joint_research_centre_best_2018} \\ Recommended\end{tabular}}}         \\ \midrule
...
\begin{tabular}{@{}ll@{}}
\toprule
\multicolumn{1}{c}{Waste Category} & \multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}Emission Threshold Limit \cite{european_commission_joint_research_centre_best_2018} \cite{govuk_waste_nodate}\\  (mg/l)\end{tabular}} \\ \midrule
