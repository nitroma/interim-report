...
\multirow{-2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Chemical  \\ Substance \cite{fischersci_sds_nodate}\end{tabular}}} & \cellcolor[HTML]{5695F1}\textbf{Health} & \cellcolor[HTML]{F85233}\textbf{Flammability} & \cellcolor[HTML]{F8FF00}\textbf{Reactivity} & \multirow{-2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Flash Point\\ (°C)\end{tabular}}} & \multirow{-2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Auto-ignition \\ Temperature \\ (°C)\end{tabular}}} & \multirow{-2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Vapour Pressure\\ (kPa) at \\ 25°C  \cite{scifinder_supplier_nodate}\end{tabular}}} & \multicolumn{1}{c}{\multirow{-2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Globally Harmonized System (GHS)\\ Hazard Codes \& Statemets \cite{pubchem_pubchem_nodate}\end{tabular}}}}                                                                                                                                                                                           \\ \cmidrule(r){1-1} \cmidrule(l){5-8} 
...
\begin{tabular}[c]{@{}c@{}} Biodegradable   \\ VOCs\end{tabular}     & \begin{tabular}[c]{@{}l@{}} \begin{itemize}
\item o-toluidine
\item Propanol
\end{itemize}o-toluidine\\ Propanol\\ Toluene\\ 2-nitrotoluene \\ 3-nitrotoleuene\\ 4-nitrotoluene \\ 4-nitrobenzoic acid\\ 4-nitrobenzyl alcohol\end{tabular} & \begin{tabular}[c]{@{}l@{}}Activated sludge process\\ Membrane filtration\end{tabular}                                \\
