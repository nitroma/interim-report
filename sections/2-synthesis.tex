...
\begin{tabularx}{\linewidth}{l|XXXS[table-format=7.0,round-mode=figures,round-precision=2]|XX|lll|S[table-format=1.3]S[table-format=1.3]c}
\toprule
                                          ...
                                          & Price (\si{\USD\per\kg}) & CAGR (\%) & Average market share of producer (\%) & {\pbox{2cm}{Demand\\ (\si{\tonne\per\year})}} & Number of reactions & Max selectivity to toluene (\%) & \rotatebox[origin=r]{90}{Health} & \rotatebox[origin=r]{90}{Flammability} & \rotatebox[origin=r]{90}{Instability} & AHP & TOPSIS & Rank \\ \midrule
