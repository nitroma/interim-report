...
Due to their high economic potential and reduced health and fire hazards, 4-aminobenzaldehyde (4-ABH), o-toluidine (o-TOL), and 4-aminobenzoic acid (4-ABA) were found to be the most valuable compounds to be produced in Nitroma's multi-purpose plant. A  summary of the selected compounds can be found in \Cref{fig:routes-chosen}.
