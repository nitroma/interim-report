...
\toprule
                                          ...
                                          & {\splitcell{Price\\(\si{\USD\per\kg})}} & {\splitcell{CAGR\\(\%)}} & \rotatebox[origin=r]{90}{\parbox{2cm}{Average market share of producer (\%)}} & {\splitcell{Demand\\(\si{\tonne\per\year})}} & \rotatebox[origin=r]{90}{\parbox{2cm}{Number of reactions}} & \rotatebox[origin=r]{90}{\parbox{2cm}{Max selectivity to toluene (\%)}} & \rotatebox[origin=r]{90}{Health} & \rotatebox[origin=r]{90}{Flammability} & \rotatebox[origin=r]{90}{Instability} & AHP & TOPSIS & Rank \\ \midrule
