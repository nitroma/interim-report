...
\begin{tabularx}{\linewidth}{l|XXXX|XX|lll|llc}
\toprule
                                          ...
                                          & Price (\si{\USD\per\kg}) & CAGR (\%) & Average market share of producer (\%) & Demand (\si{\tonne\per\year}) & Number of reactions & Max selectivity to toluene (\%) & \rotatebox[origin=r]{90}{Health} & \rotatebox[origin=r]{90}{Flammability} & \rotatebox[origin=r]{90}{Instability} & AHP & TOPSIS & Rank \\ \midrule
