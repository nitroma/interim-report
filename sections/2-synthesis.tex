...
The oxidation of 4-nitrotoluene to its benzaldehyde and benzoic acid derivatives is 
...
Examples exist of both liquid- and vapour-phase processes, with the latter now preferred for safety reasons as the nitration is highly exothermic.
...
This process gives yields of \SIlist{86;80}{\percent} for the aminobenzoic acid and aminoaldehyde respectively.
%ca va? ish
%% left it a abit too late to start writing this lol
%Bryan changed oxidation (again)
%so I can't write anything for now
%he wants to do it in gaseous phase but he didn't remove the solvent...
% cry
% maybve we should declare a stop on chainging things? just for this report?
% but if it's better then we should include it -- but maybe just for the final report?


% I spent ages making a beautiful table for safety but they went and replaced it with an ugly one again
%don't let them do that!
% they changed some numbers...
