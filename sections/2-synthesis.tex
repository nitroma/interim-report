...
4-nitrotoluene is oxidised to nitro-substituted benzyl alchohol, benzaldehyde and benzoic acid as shown in Figure xx in \Cref{app:kinetics} []. In order to produce either 4-nitrobenzaldehyde or 4-nitrobenzoic acid with the same equipment, Nitroma aims to develop a multipurpose process controlled to favour either partial or complete oxidation. 

The catalytic liquid-phase oxidation of toluene is known to produce substantial quantities of benzoic acid even when operated for the specified purpose of manufacturing benzaldehyde \cite{b}[]. For this reason, vapour-phase oxidation with oxygen was selected, since it is also a potential route for nitrobenzoic acid production \cite{maki_benzoic_2000}

Even when catalytic liquid‐phase oxidation of toluene is carried out for the express purpose of manufacturing benzaldehyde, substantial quantities of benzoic acid are formed.


Controlling the oxidation 

Nitroma aims at developing a multipurpose process 

To produce 4-nitrobenzaldehyde, it is crucial to control the partial oxidation and prevent the formation of 4-nitrobenzoic acid. 
