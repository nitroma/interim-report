...
The crystallised 4-nitrotoluene is dissolved in a methanol solvent, and then fed into a reactor to be oxidised with air. [mention reaction conditions] The operating conditions of the reactor are optimised to either partial oxidation to produce 4-nitrobenzaldehyde or complete oxidation to product 4-nitrobenzoic acid, depending on which product is desired.  

The oxidation reactors are operated in parallel, each but future work will be done to redesign the oxidation reactors to be in series to reduce the loss.
