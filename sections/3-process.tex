...
Despite an optimised reactor, 3 isomers of nitrotoluene are produced which need to be separated. The reactor effluent first passes through a decanter (S101) to separate the aqueous phase of nitric acid and water from the organic phase. The nitric acid is concentrated in a distillation column (S102) by boiling off water, before it is recycled back into the reactor to be reused. Meanwhile, the organic phase is sent to a distillation column (S103) which separates o-nitrotoluene from m & p-nitrotoluene. The p-nitrotoluene is then separated from m-nitrotoluene via a continuous crystalliser and subsequent centrifugation. As this crucial separation would determine the production rate of our downstream products, the selection of separation technique was done through a quantitative ranking, known as the Jaksland analysis []. he selection of separation techniques for 
