...
Meanwhile, the organic phase is sent to a distillation column (S103) which recovers 99. mol\% of toluene from the less volatile nitrotoluenes, and feed it back to the nitration reactor. The nitrotoluenes are sent to second distillation column (S201) to separate 99.99\% (molar basis) of the more volatile ONT from MNT and PNT. The large difference in the PNT and MNT melting points is exploited in a continuous falling-film crystalliser (S202). 
