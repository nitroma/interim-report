...
%matching the 90\% conversion rate target set by Nitroma for o-TOL. 
...
Crystallised PNT is fed into two separate oxidation reactors, currently operated in parallel, to produce either 4-NBH or 4-NBA. In an effort of plant modularity, Nitroma aims to redesign the oxidation reactors to be operated in series to reduce the CAPEX and the loss of unreacted reactants. The PNT melts and is mixed with air. Oxidation of PNT takes place in packed-bed microreactor, operating at 750K and 0.5 atm for 4-NBH production (R301), and 483K and 0.5 atm for 4-NBA production (R302). The reason for the difference in operating conditions have been detailed earlier in Section \ref{4-NTox}.
