...
In both cases, the reactor effluent is sent to a flash drum (S401) that removes air, vapourised methanol and water from the organics stream. In this preliminary design, the methanol is treated as a waste stream, although it is likely that this will be recycled in the final design. The organic stream is then fed into a second distillation column (S402) and purified before the hydrogenation reaction further downstream.
