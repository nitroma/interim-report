...
Despite an optimised reactor, 3 isomers of nitrotoluene are produced which need to be separated. The reactor effluent first passes through a decanter (unit tag) to separate the aqueous phase of nitric acid and water from the organic phase. SNitric acid is concentrated in a distillation column by boiling off water, before it is recycled back into the reactor to be reused. 
