...
\begin{wraptable}{r}{0.4\linewidth}
    ...
    \end{tabular}
\end{wraptable}
Nitroma will operate as a contract manufacturing organisation (CMO) producing 4-ABH (≥ 98\%), 4-ABA (≥ 98\%) and o-TOL (≥ 95\%). The target markets for these products are the local dye, pharmaceutical and agrochemical industries. Nitroma’s  production and market share targets are summarised in \cref{tab:production-capacity}, based on  product demand and average market shares in China (see \cref{tab:product}). The targets are set for the first 5 years of Nitroma’s operations, with the proposition of expansion under review.
...
An economic potential analysis was conducted to determine f the financial feasibility of Nitroma’s operations. Nitroma's annual profit was determined by deducting the cost of the feed stock from the revenue generated by its product line. The annual profit ranged from \$5.2m to \$12.0m, as Nitroma varied from operating 100\% of the year under the ABA scenario to 100\% under the ABH scenario. Key operating costs like utilities and revenue from by-products like MNT were not considered at this stage. Detailed calculations are found in Appendix XX. The CAPEX of the plant was estimated at \$56.2m, using the Bridgwater method. Detailed calculations are found in Appendix XX. Using the aforementioned annual profit range, this would lead to a breakeven period of 5 to 11 years.