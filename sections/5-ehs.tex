...
Following guidance from the 12 Principles of Green Engineering and the waste hierarchy system, efforts have been made to prevent waste where possible (as opposed to treating it). The traditional method of nitration involves the mixture of nitric and sulphuric acid as reagents. However, disposal of ‘spent’ sulphuric acids can be environmentally unfriendly and costly. Therefore, alternative method using recyclable zeolite catalyst will be utilised. %ref
The solvent for nitration (toluene) will be re-used through implementation of a recycle stream. The presence of waste substances is inevitable and where it cannot be avoided, efforts will be made to treat it in the most effective way possible. 